   <!-- Navbar Start -->
   <div class="container-fluid nav-bar bg-transparent bg-white">
       <nav class="navbar navbar-expand-lg bg-white navbar-light py-0 px-4">
           <a href="{{route('home')}}" class="navbar-brand d-flex align-items-center text-center">
               <div class="p-2 me-2">
                   <img class="img-fluid" src="{{url('Frontend/img/logo-souk-svg_2.png')}}" alt="Icon" style="width: 180px; height: 120px;">
               </div>
               {{-- <h1 class="m-0 text-primary logo none">Souk el-events</h1> --}}
           </a>
